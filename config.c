...
#define EASY_TARGET "ffffffffffffffffffffffffffffffffffffffffffffffffffffffffff0f0000"
...
void read_config(void)
{
	...
	srv.lp_keepalive_interval = json_integer_value(json_object_get(jcfg, "longpoll.keepalive"));
